...
public class ApptTest {
	...
	// assertions;         		
	 ...
	 public void test05() throws Throwable{
		 ...
		 int [] recur_day = {1,3,5};
		 Appt appt2 = new Appt(14,22,19,3,2019,"My Test","Yay another test");
		 appt2.setRecurrence(recur_day, Appt.RECUR_BY_WEEKLY, 1, Appt.RECUR_NUMBER_FOREVER);
		 assertEquals(1,appt2.getRecurIncrement());
